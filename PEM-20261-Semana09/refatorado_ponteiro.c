...
*-------------------------------------------------------------*
* Objetivo do Programa: Refatorado com Ponteiros              *
* Data - 01/05/2026                                           * 
* Autor: Pedro Wesley                                         *
*-------------------------------------------------------------*/
...
float processarHierarquia(Pasta *drive, int index, int nivel_atual, int limite_profundidade) {
    ...
    for (int i = 0; i < pasta_atual->qtd_sub; i++) {
        ...
        pasta_atual->tamanho_total += processarHierarquia(drive, filho_idx, nivel_atual + 1, limite_profundidade);
    }
